...
{
  "name": "@musodojo/enharmonic-note-selector",
  "version": "$VERSION",
  "description": "A custom HTML element for selecting enharmonic notes, and dispatching events with the details.",
  "keywords": [
    "music",
    "theory",
    "enharmonic"
  ...
  "repository": {
    "type": "git",
    "url": "git+https://github.com/conor-dowdall/enharmonic-note-selector.git"
  },
  "bugs": {
